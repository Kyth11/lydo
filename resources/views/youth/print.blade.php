...
<head>
    ...
    <title>KK Profiling Form Print</title>
...
<body onload="window.print()">
    ...
    <div class="page">
        ...
        <div class="header">
            ...
            <img src="{{ asset('images/OpolLogo.png') }}" class="logo-left">
            <img src="{{ asset('images/LydoLogo.png') }}" class="logo-right">
    ...
    <table class="no-border">
        ...
        <tr>
            ...
            <td>{{ $youth->source_of_income }}</td>
                ...
                <tr>
            <td class="label">Registered SK Voter:</td>
            <td>{{ $youth->is_sk_voter }}</td>
        </tr>
        <tr>
