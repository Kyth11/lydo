            ...
            <form id="accountForm" method="POST" action="{{ route('account.update') }}" class="youth-form">
                ...
                <div class="form-row">
                    <div class="w-full">
                        ...
                        <input name="email" type="email" value="{{ old('email', $user->email) }}" class="form-input w-full"
                            required>
                ...
                <div class="form-row">
                    ...
                    <div class="flex-1 relative">
                        ...
                        <div class="password-wrapper">
                            <input id="password" name="password" type="password" class="form-input w-full password-input"
                                onkeyup="checkCapsLock(event)" onkeydown="checkCapsLock(event)">

                            <span class="password-eye" onclick="togglePassword('password', this)" title="Show/Hide">
                                🙈
                            </span>
                        </div>
                    ...
                    <div class="flex-1 relative">
                        ...
                        <div class="password-wrapper">
                            ...
                            <span class="password-eye" onclick="togglePassword('password_confirmation', this)"
                                title="Show/Hide">
                                🙈
                            </span>
                        </div>
